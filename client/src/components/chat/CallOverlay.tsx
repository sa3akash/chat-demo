        ...
        return (
          <div
            ...
            style={{
              ...
              border: `1.5px solid ${color}${Math.round(opacity * 255)
                .toString(16)
                .padStart(2, "0")}`,
...
export const CallOverlay: React.FC = () => {
  ...
  const showRemoteVideoFallback =
    isVideo && isConnected && isRemoteMuted && !isScreenSharing;
        ...
        <div className="relative w-full h-full flex items-center justify-center bg-slate-950">
         ...
         <video
          ...
          {(!isConnected || showRemoteVideoFallback) && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-linear-to-br from-slate-900 via-indigo-950 to-slate-900">
              <div
                className="relative flex items-center justify-center"
              ...
              >
                <VolumeRing
                  ...
                  rings={3}
                />
                <div className="w-36 h-36 rounded-full bg-linear-to-br from-indigo-500 to-purple-700 flex items-center justify-center text-white font-bold text-5xl shadow-2xl z-10 border-4 border-white/10">
                  {partnerInitials}
                </div>
              </div>
          ...
          <div
            className={`absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-5 py-4 bg-linear-to-b from-black/70 to-transparent transition-opacity duration-300 ${controlsVisible ? "opacity-100" : "opacity-0"}`}
          >
          ...
          {/* Bottom controls bar */}
          <div
            className={`absolute bottom-0 left-0 right-0 z-20 flex flex-col items-center gap-3 px-6 pb-8 pt-16 bg-linear-to-t from-black/80 to-transparent transition-opacity duration-300 ${controlsVisible || !isConnected ? "opacity-100" : "opacity-0"}`}
          >
